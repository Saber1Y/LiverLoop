...
- Generated video clips must contain NO baked-in text: put "no text, letters, words, captions, subtitles, logos, labels, banners, or watermarks anywhere in the frame" style wording into every generated video clip prompt. ALL on-screen text (including the CTA) must be added later with ffmpeg-burn-subtitles. Baked-in text (e.g. a model-rendered "CTA" badge or a tagline banner) confuses evaluation and is treated as a defect.
